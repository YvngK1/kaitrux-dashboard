...
app.get('/api/guilds/:guildId/config', authMiddleware, async (req, res) => {
    ...
    const doc = await Prefix.findOne({
...
Object.entries(notifyModels).forEach(([name, Model]) => {
    ...
    app.get(`/api/guilds/:guildId/notify/${name}`,
        authMiddleware,
        async (req, res) => {
    ...
    app.post(`/api/guilds/:guildId/notify/${name}`,
        authMiddleware,
        async (req, res) => {
    ...
    app.delete(`/api/guilds/:guildId/notify/${name}/:id`,
        authMiddleware,
        async (req, res) => {
